...
{% include figure.html path="assets/img/2025-05-07-rlhf-generalization/reward-model.png" class="img-fluid" %}

<div class="caption">Figure 1: Reward model training process.</div>
...
{% include figure.html path="assets/img/2025-05-07-rlhf-generalization/image.png" class="img-fluid" %}

<div class="caption">Figure 2: The reinforcement learning from human feedback.</div>
...
- Subsequently, OpenAI discovered the scaling law of the reward model and RL benefits from the scaling of the reward model.<d-cite key="gao2023scaling"></d-cite>
    ...
    {% include figure.html path="assets/img/2025-05-07-rlhf-generalization/image1.png" class="img-fluid" %}
    
    <div class="caption">Figure 3: RM losses broken down by data size and RM size.</div>
    
    - Both best of N strategy and RL benefits from the scaling of reward model size and preference dataset size.
    
    {% include figure.html path="assets/img/2025-05-07-rlhf-generalization/image2.png" class="img-fluid" %}
    
    <div class="caption">Figure 4: RM data scaling experiments. RM size is held constant (12M), while RM data is varied. The x-axis has a square root scale. Note that the plots have different axes. Dotted lines indicate proxy rewards, solid lines indicate gold rewards.</div>
