...
```
{% include figure.html path="assets/img/2025-04-28-study-on-o1/comparison.png" class="img-fluid" %}
```
...
```
{% include figure.html path="assets/img/2025-04-28-study-on-o1/llm_performance_analysis.png" class="img-fluid" %}
```
...
```
{% include figure.html path="assets/img/2025-04-28-study-on-o1/route.png" class="img-fluid" %}
```
...
```
{% include figure.html path="assets/img/2025-04-28-study-on-o1/question1.png" class="img-fluid" %}
```
...
```
{% include figure.html path="assets/img/2025-04-28-study-on-o1/question2.png" class="img-fluid" %}
```
...
```
{% include figure.html path="assets/img/2025-04-28-study-on-o1/4o and o1.png" class="img-fluid" %}
```
