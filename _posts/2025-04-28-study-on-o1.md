...
<div class="row mt-3">
   <div class="col-sm mt-3 mt-md-0">
       {% include figure.html path="assets/img/2025-04-28-study-on-o1/Price2.png" class="img-fluid rounded z-depth-1" %}
   </div>
</div>
...
{% include figure.html path="assets/img/2025-04-28-study-on-o1/Speed.png" class="img-fluid rounded z-depth-1" %}
...
* The reasoning tokens in the generation process are dynamically introduced, which minimizes unnecessary computational overhead caused by extraneous
  Below is the figure which shows how the o1 model works:

{% include figure.html path="assets/img/2025-04-28-study-on-o1/principle.png" class="img-fluid rounded z-depth-1" %}
