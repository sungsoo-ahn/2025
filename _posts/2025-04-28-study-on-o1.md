...
toc:
  ...
  - name: Discussion for Complex Reasoning
    ...
    - name: Quiet-STaR as Thinking before speaking
...
Recent advancements<d-cite key="chu2024navigate"></d-cite> in CoT reasoning have introduced innovative topological structures that further enhance the model's ability to perform complex reasoning, as illustrated in above figure. These include:
...
### Quiet-STaR as Thinking before speaking
