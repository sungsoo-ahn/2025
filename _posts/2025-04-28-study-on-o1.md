...
- **Intra-chunk attention** restricts interactions to positions within the same chunk.
  The modulo operation ensures that queries and keys focus on a fixed range, significantly reducing computational complexity.
