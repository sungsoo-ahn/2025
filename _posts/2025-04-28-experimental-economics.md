...
bibliography: 2025-04-28-experimental-economics.bib  
...
<div class="row mt-3">
    ...
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/2025-04-28-experimental-economics/rock_paper_scissors.jpg" class="img-fluid" %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/2025-04-28-experimental-economics/stylized_hotel_game.jpg" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/2025-04-28-experimental-economics/language_based_persuasion_game.png" class="img-fluid" %}
    </div>
</div>
<div class="caption">
