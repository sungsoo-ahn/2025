...
In conclusion, the interplay between the state distribution shift problem and the inherent limitations of the Bradley-Terry model may result in reduced likelihoods for both positive and negative samples <d-cite key="rafailov2024from"></d-cite><d-cite key="pal2024smaug"></d-cite>. 
