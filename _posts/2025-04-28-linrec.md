...
description: Your blog post's abstract.
  This blog post explores the linear recursion as a fundamental building block of emerging deep learning architectures such as Mamba. We derive its paralallel form and gradually build towards a CUDA extension for PyTorch. We focus on the core computational structure to make Mamba accessible to a wider audience.
date: 2025-04-28
future: true
htmlwidgets: true
hidden: false
...
All the code is available as an anonymous repository [here](https://anonymous.4open.science/status/linrec-2F7F).
