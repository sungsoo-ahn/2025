...
Given that baseline approaches here are trivial and tested many times, and
given no other papers reported high results, I spared myself doing 4 more seeds
for NAR and NARsup.</d-footnote> The average accuracy for the 3 runs was $\approx$
**90%$\pm$10%** for both the self-generated and downloaded test data.
