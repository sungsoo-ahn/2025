...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/jacobi-decoding.png" class="jacobi-decoding" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/comparison_cllms.png" class="comparison_cllms" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/jacobi_traj.png" class="jacobi_traj" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/diffusion_forcing.jpg" class="diffusion_forcing" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/consistency_loss1.jpg" class="consistency_loss1" %}{% endraw %}

Alternatively, the adjacent states $$y(j), y(j+1)$$ in the Jacobi trajectory J are demanded to yield the same outputs:

{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/consistency_loss2.jpg" class="consistency_loss2" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/diffu_lm.jpg" class="diffu_lm" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/diffu_lm_loss.jpg" class="diffu_lm_loss" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/controllable_generation.jpg" class="controllable_generation" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/the_planning_task.jpg" class="the_planning_task" %}{% endraw %}
...
{% raw %}{% include figure.html path="assets/img/2025-04-28-bridging-the-parallel-decoding-of-llms-with-the-diffusion-process/mdm.jpg" class="mdm" %}{% endraw %}
