...
The **modality gap** refers to the disconnect between the feature representations of different data types. Text and images are encoded differently, making it difficult for models to relate information across modalities<d-cite key="Liang2022MindGap"></d-cite>.
...
### VISTA: Vision-Augmented Text Embeddings <d-cite key="Zhou2024VISTA"></d-cite>
...
### ColPali: Efficient Document Retrieval with Vision Language Models <d-cite key="Faysse2024ColPali" ></d-cite>
...
- **Explanation**: Heatmaps show strong attention to phrases describing AI technologies, indicating the model’s alignment with the query by combining semantic and contextual understanding.
...
- **Explanation**: The model focused on sections detailing "compensation adjustments" and "share-based plans," demonstrating its ability to extract precise financial details from complex layouts.

These examples showcase ColPali’s strength in leveraging multimodal embeddings for accurate and interpretable document retrieval.


For more details on the interpretability of this code, refer to [this article](https://medium.com/@hlealpablo/interpretability-of-colpali-in-financial-documents-5a2dcdeeba3a).
